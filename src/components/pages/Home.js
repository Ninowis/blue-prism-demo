...
const Home = () => (
  ...
  >
    ...
    <p>
      This project is based on my own <a href="https://github.com/Ninowis/react-alt-boilerplate" title="view on GitHub">React Alt Boilerplate</a> created for the purpose of this demo, feel free to browse, clone and test my workflow, it's open-source. I've done a lot of reading about some development approaches and tech you mentioned and I was not familiar with, see the about section to learn about my process and choices in making this app.
    </p>
